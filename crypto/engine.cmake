...
set(LIBCRYPTO_${LIBCRYPTO_CURRENTDIR}_SOURCES
    ...
    ${CMAKE_SOURCE_DIR}/openssl/crypto/engine/tb_ecdsa.c
    ${CMAKE_SOURCE_DIR}/openssl/crypto/engine/tb_dh.c
    ${CMAKE_SOURCE_DIR}/openssl/crypto/engine/tb_ecdh.c
    ${CMAKE_SOURCE_DIR}/openssl/crypto/engine/tb_rand.c
    ${CMAKE_SOURCE_DIR}/openssl/crypto/engine/tb_store.c
    ...
    ${CMAKE_SOURCE_DIR}/openssl/crypto/engine/engine.h
)
